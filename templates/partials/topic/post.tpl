...
{{{ end }}}
<div class="card post-container d-flex gap-2 flex-grow-1 flex-column w-100" style="min-width:0;">
	<div class="card-header d-flex align-items-start justify-content-between gap-1 flex-nowrap w-100 post-header" itemprop="author" itemscope itemtype="https://schema.org/Person">
	...
	<div class="card-content content text-break" component="post/content" itemprop="text">
		{posts.content}
	</div>

	<div class="card-footer post-footer border-bottom pb-2">
